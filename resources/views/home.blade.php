...
<br>
<div class="container-fluid"> <!-- Attendance Table -->
    <div class="row">
        <div class="col-6">
            <!-- Table with panel -->
            <div class="card card-cascade narrower">
                ...
                <div
                    ...
                    <a href="{{ url('Attendance')}}"><button  class="btn btn-rounded purple-gradient">All attendance</button></a>
        ...
        <div class="col-6">
            <!-- Table with panel -->
            <div class="card card-cascade narrower"> <!-- Vehicles Table -->
                ...
                <div class="view view-cascade gradient-card-header purple-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ url('Vehicle/create')}}"><button class="btn btn-rounded purple-gradient">Register Vehicle</button></a>
