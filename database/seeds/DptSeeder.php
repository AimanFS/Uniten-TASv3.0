...
class DptSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('staffs')->insert([
            ...
            ["name" => "Aiman Faruqy", "username" => "9003281", "email" => "aiman@test.com", "password" => Hash::make('123456'), "phoneno" => "01161033995", "is_admin" => "0", "avatar" => "profilepic.jpg", "created_at" => now(), "updated_at" => now(), "department_id" => "1"],
            ["name" => "Muhammad Syamirul", "username" => "9009865", "email" => "syamirul@test.com", "password" => Hash::make('654321'), "phoneno" => "01987654321", "is_admin" => "0", "avatar" => "profilepic.jpg", "created_at" => now(), "updated_at" => now(), "department_id" => "2"],
        ]);
